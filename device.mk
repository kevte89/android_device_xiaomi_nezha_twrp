# device.mk — Xiaomi 17 Ultra / nezha
...
# -----------------------------------------------------------------------------
PRODUCT_COPY_FILES += \
    $(DEVICE_PATH)/prebuilt/system/etc/touch/nezha_syna_thp_config.ini:recovery/root/system/etc/touch/nezha_syna_thp_config.ini
...
# Keep a recovery-owned copy of QSEE TA images outside /vendor. The runtime
# vendor mount and the modem firmware mount both hide recovery/root/vendor.
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,$(DEVICE_PATH)/prebuilt/vendor/firmware_mnt,recovery/root/sbin/nezha-firmware)
...
#
# Android 16 ramdisks expose /odm/* as symlinks into /vendor/odm/*.
# Place the real files below /vendor/odm so ramdisk assembly can keep
# those compatibility symlinks intact.
#
# Includes:
#   odm/bin/hw/*             — Goodix eSE/Weaver, StrongBox and vibrator HALs
#   odm/lib64/*              — Goodix crypto transport, haptics and touch libs
#   odm/etc/init/*           — Goodix eSE/Weaver and supporting HAL inits
#   odm/firmware/*           — Synaptics touch firmware + THP config
